module.exports = async (req, res) => {
    try {
        // Oficjalna, żywa baza Futures Only (6dca-aqww), której używa TradingView
        ...
        // Całkowicie wyłączamy pamięć podręczną serwera, aby wymusić natychmiastowe pobranie nowej bazy
